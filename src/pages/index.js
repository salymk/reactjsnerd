...
const Index = () => (
  ...
  //   <Layout>
  //     <div>
  //       <div className="bg-white pt-16 pb-20 px-4 sm:px-6 lg:pt-18 lg:pb-28 lg:px-8">
  //         <div className="max-w-lg mx-auto divide-y-4 divide-indigo-200 lg:max-w-7xl">
  //           <div>
  //             <h2 className="text-3xl tracking-tight font-extrabold text-indigo-700 sm:text-4xl">
  //               Let's get really good at reactjs, together
  //             </h2>
  ...
  //             </p>
  //           </div>
  //           <div className="absolute py-12 mb-12 mt-12 grid gap-16 pt-12 lg:grid-cols-3 lg:gap-x-5 lg:gap-y-12">
  //             {/* card beginning */}
  //             <div>
  //               <div className="relative pb-2/3">
  //                 <img
  ...
  //               </div>
  //               <div className="relative px-4 -mt-20">
  //                 <div className="bg-white p-4 rounded-lg shadow-lg border-2 border-white hover:border-indigo-400 hover:shadow-xl ">
  //                   <div>
  //                     <a href="#" className="inline-block">
  //                       <span className="inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium bg-indigo-100 text-indigo-800">
  //                         reactjs{' '}
